        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    <div class="card-header">Warehouse Picture</div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('warehouse_name') is-invalid @enderror" id="warehouse_name" name="warehouse_name" type="text" placeholder="" value="{{ old('warehouse_name') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('location') is-invalid @enderror" id="location" name="location" type="text" placeholder="" value="{{ old('location') }}" />
                            @error('location')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('size_capacity') is-invalid @enderror" id="size_capacity" name="size_capacity" type="text" placeholder="" value="{{ old('size_capacity') }}" />
                                @error('size_capacity')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
