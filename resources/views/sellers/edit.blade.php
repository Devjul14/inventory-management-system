                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('company_name') is-invalid @enderror" id="company_name" name="company_name" type="text" placeholder="" value="{{ old('company_name', $seller->company_name) }}" />
                            @error('company_name')
