        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('warehouses.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus me-3"></i>Add</a>
                    <a href="{{ route('warehouses.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
                        ...
                        <table class="table table-striped">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">@sortablelink('location')</th>
                                    <th scope="col">Size Capacity</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $warehouse->size_capacity }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('warehouses.edit', $warehouse->id) }}" class="btn btn-outline-primary btn-sm mx-1"><i class="fas fa-edit"></i></a>
